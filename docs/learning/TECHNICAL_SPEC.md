...
See [training and promotion](TRAINING_AND_PROMOTION.md) for exact evaluation procedure and [research sources](../sources/SOURCE_REGISTER.md) for SAC and predictive-control references.
