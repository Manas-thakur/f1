...
OpenF1 documents approximate 3.7 Hz car/location data and no battery-energy channel in its published car-data schema. Its location description excludes reliable lateral placement. Use it for pace/context and calibration; do not claim it provides a fully observed energy controller. See [source register](../16_sources/SOURCE_REGISTER.md).
