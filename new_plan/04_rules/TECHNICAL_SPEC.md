...
Current planning references are FIA Technical Issue 20 and Sporting Issue 08 (August 2026) plus applicable event documents. Revalidate before implementing a particular event. See [rule matrix](RULE_MATRIX.md) and [source register](../16_sources/SOURCE_REGISTER.md).
