...
The [selected stack](TECH_STACK.md) defines canonical packages, dependencies and deployment. The [learning implementation guide](../07_learning/README.md) fixes actor cadence at one second and uses the separate ordinary-return ensemble to rerank feasible finalists outside acados. Safety invalidation remains event-driven.
