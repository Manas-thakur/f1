...
Implement `apps/web/src/features/lab/` and `features/replay/` plus typed experiment-job integration. The backend simulator owns physics and snapshots. The frontend renders it and chooses experiments. Design reference: [lab](../12_design/mockups/app.html#lab), [replay](../12_design/mockups/app.html#replay).
