...
```powershell
python new_plan/tools/validate_package.py
node --check new_plan/12_design/mockups/app.js
node --check new_plan/12_design/mockups/shared.js
python -m http.server 8765 --bind 127.0.0.1 --directory new_plan/12_design/mockups
```
