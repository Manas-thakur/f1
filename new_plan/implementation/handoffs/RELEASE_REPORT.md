...
> Read `17_real_tracks_conditions` and dispatch A16. Real-circuit support
...
The dispatch table now names A16 in waves 1, 2 and 3. `new_plan/17_real_tracks_conditions/`
