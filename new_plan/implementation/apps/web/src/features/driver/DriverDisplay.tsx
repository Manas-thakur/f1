...
export function DriverDisplay({
  ...
  // The control plane's own verdict on the corridor; see DriverCircuitContext.
  ...
  return (
    <div className={`afterlap-driver-scope ${styles.scope}`} data-testid="driver-scope">
      ...
      <div className={styles.numberRow}>
        ...
        {/*
          Corridor-derived and therefore never a number here: the compiled
          package declares corridor_quality unknown, the engine holds the car
          on the centreline and the estimate carries no lateral channel. It is
          shown, rather than omitted, so the driver can see the display knows
          the field exists and is declining to state it.
        */}
        <BigNumber
