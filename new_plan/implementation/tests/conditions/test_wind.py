...
def test_crosswind_sign_is_towards_the_left():
    # Travelling east; a north wind blows south, pushing the car to its right.
    assert crosswind_mps(5.0, meteorological_direction_rad(0.0), EAST) == pytest.approx(-5.0)
    # A south wind blows north, pushing an east-bound car to its left.
