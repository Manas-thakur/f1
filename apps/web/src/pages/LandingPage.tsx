    ...
    <>
        ...
        <div className={styles.webContainer}>
          ...
          <ul className={styles.roleList}>
            <li className={styles.roleItem}>
              ...
              <h3>
                <Link to="/sessions">Operate the live decision workspace</Link>
              </h3>
              <p>
            ...
            <li className={styles.roleItem}>
              ...
              <h3>
                <Link to="/simulation-lab">Build and compare simulation branches</Link>
              </h3>
              <p>
            ...
            <li className={styles.roleItem}>
              ...
              <h3>
                <Link to="/sessions">Receive a glanceable command</Link>
              </h3>
              <p>
      ...
      <section className={styles.webSection} aria-labelledby="open">
        <div className={`${styles.webContainer} ${styles.ctaRow}`}>
          ...
          <Link className={styles.primaryLink} to="/sessions">Open sessions</Link>
        </div>
      </section>
    </>
  );
