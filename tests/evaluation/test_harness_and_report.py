...
class TestGates:
    def _fidelity(self) -> PhysicsFidelity:
        return PhysicsFidelity(
            ...
            reference="simulation/NUMERICS_AND_VALIDATION.md reference equations",
    ...
    def test_an_approved_bundle_requires_a_report_and_a_frozen_policy(self) -> None:
        with pytest.raises(ValueError, match="benchmark report"):
            ModelManifest(
                ...
                id="candidate-1",
                algorithm="sac",
                weights_hash="sha256:9a129038d9a00aed0cf6a7ea059ca50a813449061ab87848cf1a13eafdf33b2c",
